...
const headCells = [
    ...
    { id: 'user_id_to',      api_label:'ord_user_id_to',      numeric: true, disablePadding: true, label: 'User ID to', asc: 'false', direction: 'desc'},
    { id: 'user_id_from',    api_label:'ord_user_id_from',    numeric: true, disablePadding: true, label: 'User ID from', asc: 'false', direction: 'desc'},
    { id: 'u_to_fullname',   api_label:'ord_u_to_fullname',   numeric: true, disablePadding: true, label: 'User to full name', asc: 'false', direction: 'desc' },
    { id: 'u_from_fullname', api_label:'ord_u_from_fullname', numeric: true, disablePadding: true, label: 'User from full name', asc: 'false', direction: 'desc' },
    ...
    { id: 'created_at',      api_label:'ord_created_at',      numeric: true, disablePadding: true, label: 'Created at', asc: 'false', direction: 'desc' },
    { id: 'updated_at',      api_label:'ord_updated_at',      numeric: true, disablePadding: true, label: 'Updated at', asc: 'false', direction: 'desc' },
            ...
            if (filterGroup.checkbox_value) {
                ...
                if (filterGroup.checkbox_name === 'createdAtFilterCheck'){
                    ...
                    if (this.state.minCreatedAt != null) {
                        appliedFilters.minCreatedAt = new Date(this.state.minCreatedAt.getTime()
                            - (this.state.minCreatedAt.getTimezoneOffset()*60000)).toJSON()
                    }
                    if (this.state.maxCreatedAt != null) {
                        appliedFilters.maxCreatedAt = new Date(this.state.maxCreatedAt.getTime()
                            - (this.state.maxCreatedAt.getTimezoneOffset()*60000)).toJSON()
        ...
        return (
            <div>
                                ...
                                <Grid container direction={'column'} alignItems={'flex-start'}>
                                    <Grid item>
                                        <CssFormControlLabel
                                            ...
                                            label="Apply activation status filter"
                                        />
                                    </Grid>
                                    <Grid item>
                                        <PUSelect
                                            change_handler={this.handleActivatedChange}
                                            combobox_label="Activation status"
                                            cb_min_width="200px"
                                            select_options={[
                                                {'id': null, 'label': ''},
                        ...
                        <Grid container direction={'column'} alignItems={'flex-start'}>
                            ...
                            <Grid item>
                                <CssFormControlLabel
                                    ...
                                    label="Apply user ID from filter"
                                />
                            </Grid>
                            <Grid item>
                                <TFID
                                    tf_label="User ID from"
                                    tf_min_width="200px"
                                    tf_max_width="200px"
                                    tf_variant="outlined"
                        ...
                        <Grid container direction={'column'} alignItems={'flex-start'}>
                            <Grid item>
                                <CssFormControlLabel
                                    ...
                                    label="Apply user to filter by full name"
                                />
                            </Grid>
                            <Grid item>
                                <TFName
                                    tf_label="User to full name"
                                    tf_min_width="200px"
                                    tf_max_width="200px"
                                    tf_variant="outlined"
                                    tf_default_value=""
                            ...
                            <Grid item>
                                <CssFormControlLabel
                                    ...
                                    label="Apply user from filter by full name"
                                />
                            </Grid>
                            <Grid item>
                                <TFName
                                    tf_label="User from full name"
                                    tf_min_width="200px"
                                    tf_max_width="200px"
                                    tf_variant="outlined"
                                    tf_default_value=""
                    ...
                    <Grid container spacing={6} direction={'row'} justify={'space-between'}>
                        ...
                        <Grid item>
                            <Grid container spacing={6} direction={'row'} justify={'flex-end'}>
                                <Grid item>
                                    <Button
                                        onClick = {this.generateXlsReport}
                                        color="primary" variant="contained"
                                        style={buttonStyle}
                                    >
                                        Export xls
                ...
                <Grid container spacing={1} direction={'row'} justify={'flex-end'}>
                    <Grid item>
                        <p>Page {this.state.current_page + 1} of {this.state.total_pages + 1}</p>
                    </Grid>
                    <Grid item>
                        <PUSelect
